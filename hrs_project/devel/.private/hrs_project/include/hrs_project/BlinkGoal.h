// Generated by gencpp from file hrs_project/BlinkGoal.msg
// DO NOT EDIT!


#ifndef HRS_PROJECT_MESSAGE_BLINKGOAL_H
#define HRS_PROJECT_MESSAGE_BLINKGOAL_H
...
struct BlinkGoal_
{
  ...
  typedef boost::shared_ptr< ::hrs_project::BlinkGoal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::hrs_project::BlinkGoal_<ContainerAllocator> const> ConstPtr;

}; // struct BlinkGoal_

typedef ::hrs_project::BlinkGoal_<std::allocator<void> > BlinkGoal;

typedef boost::shared_ptr< ::hrs_project::BlinkGoal > BlinkGoalPtr;
typedef boost::shared_ptr< ::hrs_project::BlinkGoal const> BlinkGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::hrs_project::BlinkGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::hrs_project::BlinkGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::hrs_project::BlinkGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::hrs_project::BlinkGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::hrs_project::BlinkGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::hrs_project::BlinkGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::hrs_project::BlinkGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::hrs_project::BlinkGoal_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::hrs_project::BlinkGoal_<ContainerAllocator> >
{
  ...
  static const char* value(const ::hrs_project::BlinkGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5e5d3c2ba9976dc1ULL;
  static const uint64_t static_value2 = 0x21a0bb6ef7c66d79ULL;
};

template<class ContainerAllocator>
struct DataType< ::hrs_project::BlinkGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "hrs_project/BlinkGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::hrs_project::BlinkGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::hrs_project::BlinkGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::hrs_project::BlinkGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::hrs_project::BlinkGoal_<ContainerAllocator>& v)
  {
...
#endif // HRS_PROJECT_MESSAGE_BLINKGOAL_H
