...
(cl:defmethod cl:initialize-instance :after ((m <BlinkGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BlinkGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hrs_project-msg:<BlinkGoal> is deprecated: use hrs_project-msg:BlinkGoal instead.")))

(cl:ensure-generic-function 'colors-val :lambda-list '(m))
(cl:defmethod colors-val ((m <BlinkGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hrs_project-msg:colors-val is deprecated.  Use hrs_project-msg:colors instead.")
  (colors m))

(cl:ensure-generic-function 'bg_color-val :lambda-list '(m))
(cl:defmethod bg_color-val ((m <BlinkGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hrs_project-msg:bg_color-val is deprecated.  Use hrs_project-msg:bg_color instead.")
  (bg_color m))

(cl:ensure-generic-function 'blink_duration-val :lambda-list '(m))
(cl:defmethod blink_duration-val ((m <BlinkGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hrs_project-msg:blink_duration-val is deprecated.  Use hrs_project-msg:blink_duration instead.")
  (blink_duration m))

(cl:ensure-generic-function 'blink_rate_mean-val :lambda-list '(m))
(cl:defmethod blink_rate_mean-val ((m <BlinkGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hrs_project-msg:blink_rate_mean-val is deprecated.  Use hrs_project-msg:blink_rate_mean instead.")
  (blink_rate_mean m))

(cl:ensure-generic-function 'blink_rate_sd-val :lambda-list '(m))
(cl:defmethod blink_rate_sd-val ((m <BlinkGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hrs_project-msg:blink_rate_sd-val is deprecated.  Use hrs_project-msg:blink_rate_sd instead.")
  (blink_rate_sd m))
