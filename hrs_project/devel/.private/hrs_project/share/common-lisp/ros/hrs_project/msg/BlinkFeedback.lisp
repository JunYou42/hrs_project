...
(cl:defmethod cl:initialize-instance :after ((m <BlinkFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BlinkFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hrs_project-msg:<BlinkFeedback> is deprecated: use hrs_project-msg:BlinkFeedback instead.")))

(cl:ensure-generic-function 'last_color-val :lambda-list '(m))
(cl:defmethod last_color-val ((m <BlinkFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hrs_project-msg:last_color-val is deprecated.  Use hrs_project-msg:last_color instead.")
  (last_color m))
